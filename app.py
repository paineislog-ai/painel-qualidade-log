# -*- coding: utf-8 -*-
# ============================================================
# Painel de Qualidade — LOG (multi-meses)
# ============================================================
...
# ------------------ CONFIG BÁSICA ------------------
st.set_page_config(page_title="Painel de Qualidade — LOG", layout="wide")
st.title("🎯 Painel de Qualidade — LOG")
...
# ============= METAS POR CIDADE – LOG =============
def _norm_city(x: str) -> str:
    return _strip_accents(_upper(x))

CITY_METAS = {
    _norm_city("TIMON"):                 (3.5, 1.5),
    _norm_city("AÇAILÂNDIA"):            (3.5, 1.5),
    _norm_city("CAROLINA"):              (3.5, 1.5),
    _norm_city("PRESIDENTE DUTRA"):      (3.5, 1.5),
...
if not ok_openpyxl:
    ...
    st.download_button(
        ...
        data=xbuf,
        file_name="erros_por_vistoriador_log.xlsx",
...
def _fora_meta(base_m):
    ...
    - metas por cidade (LOG) via _metas_cidade + city_map
    """
    base_m = base_m.copy()
